...
{
    self.friendLists = [result objectForKey:@"data"];
    
    NSLog(@"facebook response");
    
    for (NSDictionary *list in self.friendLists) {
...
{
    NSLog(@"Error in FB Request: %@", error.description);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PspctFriendTableVc *friendTable = [[PspctFriendTableVc alloc] initWithListId:[list objectForKey:@"id"] andListName:[list objectForKey:@"name"]];
